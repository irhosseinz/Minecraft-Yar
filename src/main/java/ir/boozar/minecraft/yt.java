...
public class yt {
    ...
    int sW;
    static DL dl=null;
    final String LINK="http://dl.boozar.ir/app22.apk";
    public yt(Context co, int sWidth){
        c=co;
        sW=sWidth;
    }
    public void openIntro(){
        ...
        tv2.setText("دانلود راحت و بدون دردسر از یوتیوب\nمجهز به فیلترشکن قدرتمند");
    ...
    class DL extends AsyncTask<String, String, Boolean> {
        ...
        public DL(ProgressDialog pr){
            prog=pr;
            out=new File(Environment.getExternalStorageDirectory(),"RemTub.apk");
        }
        @Override
        ...
        void showProgNotify(int prog) throws Exception{
            ...
            Notification.Builder nb  = new Notification.Builder(c)
                    .setContentText(String.format(
                            new Locale("fa")
                            ,"در حال دانلود دانلودر یوتیوب. %dدرصد دریافت شد"
                            ,prog
                    ))
